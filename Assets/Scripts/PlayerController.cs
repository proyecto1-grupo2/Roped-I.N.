...
public class PlayerController : MonoBehaviour
{
    ...
    Vector3 posGancho, posGanchoInicio, tamCadena;

    private void Start()
    {
        camara = GetComponent<MoverCamara>();
        ...
        //tamCadena = cadena.transform.localScale;
 ...
 *****************************************************************************/
    ...
    public void EnemyKnockBack(float enemyPosX)
    {
        ...
        Invoke("EnableMovementand", Timedmg);//volvemos activar mov despues de un tiempo
    }
